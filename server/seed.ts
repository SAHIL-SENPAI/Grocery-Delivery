...
const seedDB = async ()=>{
    try{
        ...
        const cleanedProducts = dummyData.map(({ _id, __v, createdAt, updatedAt, discount,id, ...product }) => product);

        const products:Prisma.ProductCreateManyInput[] = cleanedProducts;

        await prisma.product.createMany({data:products})

        console.log(`Created ${products.length} products`);
        console.log("Seed completed sucessfully!")
