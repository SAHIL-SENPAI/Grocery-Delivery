                ...
                lg:gap-10">
                    ...
                    <div className="flex items-center gap-3">  
                        ...
                        <button  onClick={()=>setIsCartOpen(true)} className="relative p-2 rounded-xl">
                            ...
                            {cartCount > 0 && <span className="absolute
                            -top-1 -right-1 size-4 bg-app-orange text-white
                            text-[10px] rounded-full flex-center">{cartCount}</span>}
                        </button>
                        ...
                        <div className="relative">
                            ...
                            (
                                <div className="flex-center gap-2">
                                    <Link to="/login"
                                    className="hidden md:flex items-center gap-2 px-4  py-2 text-sm
                                    font-medium text-white bg-green-950 rounded-full hover:bg-green-950-light
                                    transition-colors">
                                    ...
                                    <div onClick={()=>setUserMenuOpen(false)}>
                                        ...
                                        {user && (
                                            <div className="border-t border-app-border pt-1">
                                                <button onClick={handleLogout} className="flex items-center gap-3 px-4
                                                py-2.5 text-sm text-app-error hover:bg-red-50 w-full
                                                transition-colors">
