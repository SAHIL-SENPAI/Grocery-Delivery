...
const AppPromoBanner = () => {
    return (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 my-14 
        bg-green-950 rounded-2xl">
            ...
            gap-8 xl:px-10">
                ...
                {/* right side image */}
            <img src={assets.delivery_truck} alt="delivery_truck" className="
            max-w-60 sm:max-w-120 xl-pr-10" />
            </div>
