    ...
    return (
        ...
        onClick={()=>navigate(`/products/${product._id}`)}>
            ...
            <div className="relative aspect-square overflow-hidden">
                ...
                p-4 group-hover:p-2 transition-all duration-300" />

                {/* Badges */}
                <div className="absolute top-3 left-3 flex flex-wrap gap-1.5">
                    {/* only show if discount is greater than 0 */}
                    {product.discount > 0 && <span className="px-2 py-0.5 text-[10px]
                    font-semibold uppercase bg-app-orange text-white
                    rounded-full">{product.discount}% OFF</span> }
            ...
            <div className="p-3.5 text-zinc-700">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1 truncate">
                        ...
                        {product.originalPrice > product.price && <span className="
                        text-xs text-app-text-light line-through ml-1.5">{currency}
                    ...
                    flex-center shrink-0 hover:bg-app-orange-dark transition-colors
                    active:scale-95">
