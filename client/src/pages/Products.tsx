...
const Products = () =>{
    ...
    return(
        <div className="min-h-screen bg-app-cream">
                ...
                <div className="flex gap-8 xl:gap-10">
                    ...
                    <aside className="hidden lg:block w-64 shrink-0">
                        <div className="bg-white rounded-2xl p-4 sticky top-24">
                            ...
                            clearFilter={clearFilter} hasFilters={hasFilters}/>
                        </div>
                        ...
                        {loading?( 
                            ...
                            <div className="text-center py-16">
                                ...
                                <button onClick={clearFilter}
                                 className="px-5 py-2 text-sm font-medium bg-app-green
                                text-white rounded-xl hover:bg-app-green-light transition-colors">
                                    Clear Filters
                                </button>
                            </div>
                        ): (
                        ...
                        {totalPages>1 && (
                            <div className="flex-center gap-2 mt-16">
                                {Array.from({length:totalPages}).map((_,i)=>(
                                    <button key={i} onClick={()=>{updateFilter("page",String(i+1)); scrollTo(0,0)}} className={`size-9 rounded-lg text-sm
                                    font-medium transition-colors ${page === i+1 ? "bg-app-green text-white" : "bg-white text-app-text-light hover:bg-app-cream"}`}>
                                        {i+1}
                                    </button>
                                ))}
                            </div>
            ...
            {mobileFilterOpen && (
                <>
                    <div onClick={()=>setMobileFilterOpen(false)} className="fixed inset-0 bg-black/40 z-50"/>
