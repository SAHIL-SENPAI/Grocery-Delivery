...
export default function DeliveryDashboard() {
    ...
    // live location share every 10 sec
    useEffect(()=>{
        ...
        // also send on interval for constant updates
    ...
    const handleUpdateStatus = async (orderId: string, status: string) => {
        try {
            axios.put(`${API_URL}/delivery/my-deliveries/${orderId}/status`,{status},getAuthHeaders());
