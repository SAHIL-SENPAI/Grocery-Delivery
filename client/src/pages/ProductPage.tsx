    ...
    return(
        <div className="min-h-screen">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                {/* breadcrumb // navigation path shown on top */}
                ...
                {/* back button */}
                <button onClick={()=>navigate(-1)} className="mb-6 flex items-center gap-1.5 text-sm text-app-text-light
                ...
                <div className="bg-white/50 rounded-2xl overflow-hidden">
                    <div className="grid md:grid-cols-2 gap-0">
                        {/* left side image */}
                        <div className="relative flex-center p-8 md:p-12 min-h-[320px] 
                        md:min-h-[480px]">
                            <img className="max-h-[360px] w-auto object-contain" src={product.image} alt={product.name} />
                            <div className="absolute top-5 left-5 flex flex-wrap gap-1.5">
                                ...
                                {product.discount > 0 &&(
                                    ...
                                    font-semibold bg-app-orange text-white rounded-full">
                        ...
                        <div className="p-6 md:p-10 flex flex-col justify-center">
                            ...
                            tracking-wider capitalize mb-2">{categoryLabel}</span>
                            ...
                            <div className="flex items-center gap-3">
                                {/* quantity */}
                                <div className="flex items-center border border-app-border
                                rounded-xl overflow-hidden">
                                    <button onClick={handleMinus}
                                     className="p-3 hover:bg-app-cream transition-colors">
                                        <MinusIcon className="w-4 h-4"/>
                                    </button>
                                    <span className="px-5 text-sm font-semibold min-w-[40px]
                                    text-center">{displayQuantity}</span>
                                ...
                                <button 
                                 ...
                                 className={`flex-1 py-3 font-semibold rounded-xl
                                    transition-colors flex-center gap-2 disabled:opacity-50
                                    disabled:cursor-not-allowed active:scale-[0.98 ${inCart?
                ...
                {relatedProducts.length > 0 && (
                    <section className="mt-12 mb-44">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            hover:text-app-orange-dark flex items-center gap-1
                            transition-colors"
